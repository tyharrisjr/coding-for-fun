...
exports.downloadSdkBuildTools = exports.getBuildToolsAvailableVersions = exports.execBinarySync = exports.installPackagesUsingSdkManager = exports.downloadAndSetupAndroidSdk = exports.getDefaultAndroidSdkRoot = void 0;
...
const downloadAndSetupAndroidSdk = async (sdkRoot, platform) => {
    ...
    await (0, common_1.downloadWithProgressBar)(downloads_json_1.default.sdk[platform], sdkRoot, true);
    // re-arrange files
